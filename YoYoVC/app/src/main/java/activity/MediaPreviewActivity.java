...
import Tools.IsUtils;
import Tools.ResourceUtils;
import customView.FrameImageView;
import customView.VideoView;
 ...
 *
 */
public class MediaPreviewActivity extends VideoBaseActivity implements OnClickListener, VideoView.OnPlayStateListener, OnPreparedListener {
